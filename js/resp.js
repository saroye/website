...
c_slide.style.Transform = 'translateX(' + (- size * counter ) + 'px)';
//c_slide.style.Transform = 'translateX(' + (- size * counter ) + 'px)';
c_slide1.style.Transform = 'translateX(' + (- size * counter ) + 'px)';
c_slide2.style.Transform = 'translateX(' + (- size * counter ) + 'px)';
c_slide3.style.Transform = 'translateX(' + (- size * counter ) + 'px)';
...
c_slide1.addEventListener('transitionend' ,() =>{
    if(c_imgs1[counter].id == 'lastClone1'){
        ...
        c_slide1.style.Transform = 'translateX(' + (-size*counter1) + 'px)';
    }
...
c_slide2.addEventListener('transitionend' ,() =>{
    if(c_imgs2[counter].id == 'lastClone2'){
        ...
        c_slide2.style.Transform = 'translateX(' + (-size*counter2) + 'px)';
    }
...
c_slide3.addEventListener('transitionend' ,() =>{
    if(c_imgs3[counter].id == 'lastClone3'){
        ...
        c_slide3.style.Transform = 'translateX(' + (-size*counter3) + 'px)';
    }
